...
function buttonCotrol(obj) {
    ...
    switch (obj.id) {
        ...
        setTimeout(function () { 
        var $toastContent = $('<div class="row"><div class="col s2 left"><i class="material-icons">file_download</i></div><div class="col s10 white-text">C:\\Advanced Combat Tracker<br>　\\ScreenShot</div></div>');
