...
function buttonCotrol(obj) {
    ...
    switch (obj.id) {
        ...
        setTimeout(function () { 
        var $toastContent = $('<div class="row"><div class="col s1"><i class="material-icons">file_download</i></div><div class="col s11 white-text">C:\\Advanced Combat Tracker\\ScreenShot</div></div>');
