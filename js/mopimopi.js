...
function inputBarData(bar, barOverheal, barShield, barPet, a, flag) {
    ...
    if (localStorage.getItem("youColor") == 1 && a.get("name") == "YOU") {
        bar.style.backgroundColor = '#' + localStorage.getItem("YOU");
    }
    else {
        switch (a.get("Class")) {
    ...
    if (flag == 'Healer')  //힐러 
    {
        ...
        if (localStorage.getItem("pets") == 1) {    //합산
            ...
            if (a.get("Class") == "SCH") {
                ...
                console.log("길이 : " + petHealed + " 펫힐량 : " + a.get("mergedHealed") + " 유저힐량 : " + a.get("original").Healed + " 맥스데미지 : " + a.get("maxdamage"));
            } else {
                petHealed = 0 + '%';
            }
        } else {
